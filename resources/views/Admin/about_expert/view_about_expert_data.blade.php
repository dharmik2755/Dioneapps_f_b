...
<div class="main-panel">
    <div class="content-wrapper">
        ...
        <div class="card">
            <div class="card-body">
                <div class="text-end">
                    <a href="{{ route('about.expert.create') }}">
                                ...
                                <tbody>
                                    @foreach ($about_experts as $dt)
                                        <tr>
                                            ...
                                            <td>
                                                {{-- edit link --}}
                                                <a href="{{ url('/edit-about-page-expert-data/' . $dt->id) }}">
                                            ...
                                            <td>
                                                {{-- delete link --}}
                                                <a href="{{ url('/delete-about-page-expert-data/'. $dt->id) }}">
      ...
      $('.toggle-class').change(function() {
        //   alert();
          ...
          $.ajax({
                  type: "GET",
                  dataType: "json",
                  url: '/stutus-about-page-expert-data',
