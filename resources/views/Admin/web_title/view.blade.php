                                ...
                                <tbody>
                                    @foreach ($web_title as $dt)
                                        <tr>
                                            ...
                                            <td>
                                                {{-- edit link --}}
                                                <a href="{{ url('/edit-web-title-data/' . $dt->id) }}">
                                            ...
                                            <td>
                                                <a href="{{ url('/delete-web-title-data/'. $dt->id) }}">
