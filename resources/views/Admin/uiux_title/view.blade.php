...
<div class="main-panel">
    <div class="content-wrapper">
        ...
        <div class="card">
            <div class="card-body">
                <div class="text-end">
                    <a href="{{ route('uiux-title.create') }}">
                                ...
                                <tbody>
                                    @foreach ($uiux_title as $dt)
                                        <tr>
                                            ...
                                            <td>
                                                {{-- edit link --}}
                                                <a href="{{ url('/edit-uiux-title-data/' . $dt->id) }}">
                                            ...
                                            <td>
                                                <a href="{{ url('/delete-uiux-title-data/'. $dt->id) }}">
