...
<div class="main-panel">
    <div class="content-wrapper">
        ...
        <div class="card">
            <div class="card-body">
                <div class="text-end">
                    <a href="{{ route('services-offer.create') }}">
                                ...
                                <tbody>
                                    @foreach ($services_offer as $dt)
                                        <tr>
                                            ...
                                            <td>
                                                {{-- edit link --}}
                                                <a href="{{ url('/edit-services-offer-data/' . $dt->id) }}">
                                            ...
                                            <td>
                                                {{-- delete link --}}
                                                <a href="{{ url('/delete-services-offer-data/'. $dt->id) }}">
      ...
      $('.toggle-class').change(function() {
        //   alert();
          ...
          $.ajax({
                  type: "GET",
                  dataType: "json",
                  url: '/stutus-services-offer-data',
