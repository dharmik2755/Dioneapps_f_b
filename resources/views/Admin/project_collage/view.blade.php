...
<div class="main-panel">
    <div class="content-wrapper">
        ...
        <div class="card">
            <div class="card-body">
                <div class="text-end">
                    <a href="{{ route('project-collage.create') }}">
                                ...
                                <tbody>
                                    @foreach ($data as $dt)
                                        <tr>
                                            <td>{{ $dt->id }}</td>
                                            <td>
                                                <img height="200px" width="200px" src="{{ URL('upload/' . $dt->image) }}" alt="">
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                {{-- edit link --}}
                                                <a href="{{ url('/edit-project-collage-data/' . $dt->id) }}">
                                            ...
                                            <td>
                                                {{-- delete link --}}
                                                <a href="{{ url('/delete-project-collage-data/'. $dt->id) }}">
          ...
          $('.toggle-class').change(function() {
            //   alert();
              ...
              $.ajax({
                      type: "GET",
                      dataType: "json",
                      url: '/stutus-project-collage-data',
