                  ...
                  <fieldset>
                    <div class="row">
                        <div class="form-group col-3 ">
                            ...
                            <input id="firstname" class="form-control" name="clients" type="text" placeholder="clients" value="{{$dt->clients}}" >
                          </div>
                          <div class="form-group col-3">
                            <label for="firstname">Projects</label>
                            <input id="firstname" class="form-control" name="projects" type="text"     placeholder=" Projects" value="{{$dt->projects}}" >
                          </div>
                          <div class="form-group col-3">
                            <label for="lastname">Employees</label>
                            <input id="lastname" class="form-control" name="employees" type="text" placeholder="employees" value="{{$dt->employees}}" >
                          </div>
                          <div class="form-group col-3">
                            <label for="lastname">Branches</label>
                            <input id="lastname" class="form-control" name="branches" type="text" placeholder="branches" value="{{$dt->branches}}" >
                          </div>
                    </div>
