                            ...
                            <fieldset>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <input type="file" id="color_image" class="form-control file-upload-info"
                                                style="width: 100%" name="color_image" placeholder="Upload Image"><br>
                                        </div>
                                        <div class="col-6">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <input type="file" id="black_image" class="form-control file-upload-info"
                                                style="width: 100%" name="black_image" placeholder="Upload Image"><br>
                                        </div>
                                        <div class="col-6">
