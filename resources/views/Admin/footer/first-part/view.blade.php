...
<div class="main-panel">
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title"> Footer Company Information Data table </h3>
        ...
        <div class="card">
            <div class="card-body">
                <div class="text-end">
                    <a href="{{ route('footer-first.create') }}">
                                ...
                                <tbody>
                                    @foreach ($footer_first as $dt)
                                        <tr>
                                            ...
                                            <td>
                                                {{-- edit link --}}
                                                <a href="{{ url('/edit-footer-first-data/' . $dt->id) }}">
                                            ...
                                            <td>
                                                {{-- delete link --}}
                                                <a href="{{ url('/delete-footer-first-data/'. $dt->id) }}">
